      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          <Link 
            ...
            className={`text-2xl font-black transition-all duration-300 ${isScrolled ? 'text-black dark:text-white' : ''} animate-glitch inline-block`}
          >
            DEV.
          </Link>
          ...
          <ul className="flex flex-col py-3 uppercase font-bold text-sm">
            <li>
              <Link 
                to="/#home" 
                onClick={(e) => handleNavigation(e, 'home')}
                className="block py-3 px-4 hover:bg-secondary hover:text-white dark:hover:text-black transition-colors"
              >
                Home
              </Link>
            </li>
