...
const Contact = () => {
  ...
  return (
    <section id="contact" className="brutalist-section bg-white dark:bg-black dark:text-white relative">
      <div className="grain-overlay"></div>
      <div className="container mx-auto relative z-10">
        <h2 className="text-4xl md:text-5xl mb-12 reveal">
          <span className="bg-black text-white dark:bg-white dark:text-black px-2 py-1 brutal-box inline-block">Contato</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="reveal">
            ...
            <div className="space-y-6">
              ...
              <div className="flex mt-6 space-x-4 reveal">
                <a href="#" className="w-12 h-12 bg-black dark:bg-white flex items-center justify-center brutal-box hover:bg-secondary transition-colors">
                ...
                <a href="#" className="w-12 h-12 bg-black dark:bg-white flex items-center justify-center brutal-box hover:bg-secondary transition-colors">
                  <Instagram size={20} className="text-white dark:text-black" />
                </a>
                <a href="#" className="w-12 h-12 bg-black dark:bg-white flex items-center justify-center brutal-box hover:bg-secondary transition-colors">
                  <Smartphone size={20} className="text-white dark:text-black" />
                </a>
              </div>

              <div className="mt-8 pt-8 border-t-2 border-black dark:border-white reveal">
