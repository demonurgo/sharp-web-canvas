      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, index) => (
            <div 
              key={index} 
              className="group brutal-box bg-white dark:bg-black animate-fade-in-up project-card hover:opacity-100"
            ...
            >
              ...
              <div className="p-4">
                ...
                <Link 
                  ...
                  className="font-bold uppercase text-black dark:text-white hover:text-accent hover:opacity-100 flex items-center gap-2 group-hover:translate-x-1 transition-transform"
                >
                  Ver detalhes 
